...
learningdata$groupname <- sprintf("%s, %s group", learningdata$grade, learningdata$treat)
...
d_ply(learningdata, c("grade", "treat"), function(groupdata) {
    ...
    age_sex_literacy <- dcast(groupdata, AgeGroup + sex ~ literacy_level, length,
